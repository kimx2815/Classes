 ...
 *   LANG_NAME
 */
package edu.umn.cs.melt.ableC.artifacts.ide_basic.eclipse.console;
...
public class EDUConsole {

	private final static String CONSOLE_NAME = EDUPlugin.kLanguageID + " Console";
