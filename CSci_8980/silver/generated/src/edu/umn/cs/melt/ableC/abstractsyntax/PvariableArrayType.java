...
public final class PvariableArrayType extends edu.umn.cs.melt.ableC.abstractsyntax.NArrayType {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_variableArrayType;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:variableArrayType erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:variableArrayType";
	}

	static void initProductionAttributeDefinitions() {
		// top.pp = size.pp
		edu.umn.cs.melt.ableC.abstractsyntax.PvariableArrayType.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_ArrayType] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)((common.DecoratedNode)context.childAsIs(edu.umn.cs.melt.ableC.abstractsyntax.PvariableArrayType.i_size)).synthesized(edu.umn.cs.melt.ableC.abstractsyntax.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_Expr)); } };
