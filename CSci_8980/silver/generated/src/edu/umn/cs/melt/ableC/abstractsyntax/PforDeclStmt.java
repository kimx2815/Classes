...
public final class PforDeclStmt extends edu.umn.cs.melt.ableC.abstractsyntax.NStmt {
	...
	public static final Class<?> childTypes[] = {edu.umn.cs.melt.ableC.abstractsyntax.NDecls.class,edu.umn.cs.melt.ableC.abstractsyntax.NMaybeExpr.class,edu.umn.cs.melt.ableC.abstractsyntax.NMaybeExpr.class,edu.umn.cs.melt.ableC.abstractsyntax.NStmt.class};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_forDeclStmt;
	...
	static {
	childInheritedAttributes[i_i] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.NDecls.num_inh_attrs];
	...
	public final edu.umn.cs.melt.ableC.abstractsyntax.NDecls getChild_i() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.NDecls) (child_i = common.Util.demand(child_i));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:forDeclStmt erroneously claimed to forward");
	}
