...
// top::BuiltinType ::= 
public final class PvoidType extends edu.umn.cs.melt.ableC.abstractsyntax.NBuiltinType {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_voidType;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:voidType erroneously claimed to forward");
	}
