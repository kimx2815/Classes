...
public final class PreadScope_i extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_name, final Object c_scope) {
		...
		return (common.ConsCell)(new common.PatternLazy<common.ConsCell, common.ConsCell>() { public final common.ConsCell eval(final common.DecoratedNode context, common.ConsCell scrutineeIter) {final common.ConsCell scrutinee = scrutineeIter; if(!scrutineeIter.nil()) {final common.Thunk<Object> __SV_LOCAL___sv_pv_57_h = new common.Thunk<Object>(context) { public final Object doEval() { return scrutinee.head(); } };
final common.Thunk<Object> __SV_LOCAL___sv_tmp_pv_58 = new common.Thunk<Object>(context) { public final Object doEval() { return scrutinee.tail(); } };
return ((common.ConsCell)(new common.Thunk<Object>(context) { public final Object doEval() { final common.Thunk<Object> __SV_LOCAL_h = new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)(__SV_LOCAL___sv_pv_57_h.eval())); } };
return ((common.ConsCell)(__SV_LOCAL_h.eval())); } }).eval()); }
else if(scrutinee.nil()) { return (common.ConsCell)((common.ConsCell)core.Pnil.invoke()); }return ((common.ConsCell)core.Perror.invoke((new common.StringCatter("Error: pattern match failed at edu:umn:cs:melt:ableC:abstractsyntax:env 'EnvPlumbing.sv', 23, 9\n"))));}}.eval(context, (common.ConsCell)((common.ConsCell)core.PdropWhile.invoke(core.Pnull.factory, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pmap.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return silver.util.raw.treemap.Plookup.factory.invokePartial(new int[]{0}, new Object[]{context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PreadScope_i.i_name)}); } }, context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PreadScope_i.i_scope))); } }))));
