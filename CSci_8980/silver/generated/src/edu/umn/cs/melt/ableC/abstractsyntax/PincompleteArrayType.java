...
// top::ArrayType ::= 
public final class PincompleteArrayType extends edu.umn.cs.melt.ableC.abstractsyntax.NArrayType {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_incompleteArrayType;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:incompleteArrayType erroneously claimed to forward");
	}
