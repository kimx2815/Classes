...
public final class PtheParser extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_artifacts_parse_only_theParser;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:artifacts:parse_only:theParser";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		try {
			return new core.PparseSucceeded( new edu.umn.cs.melt.ableC.artifacts.parse_only.Parser_edu_umn_cs_melt_ableC_artifacts_parse_only_theParser().parse(new java.io.StringReader(((common.StringCatter)common.Util.demand(c_stringToParse)).toString()), ((common.StringCatter)common.Util.demand(c_filenameToReport)).toString()) );
			...
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:artifacts:parse_only:theParser", t);
		}
	}
