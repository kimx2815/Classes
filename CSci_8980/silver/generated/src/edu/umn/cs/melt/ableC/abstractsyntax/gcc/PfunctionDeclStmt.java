...
public final class PfunctionDeclStmt extends edu.umn.cs.melt.ableC.abstractsyntax.NStmt {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_gcc_functionDeclStmt;
	...
	static {
	childInheritedAttributes[i_d] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.NFunctionDecl.num_inh_attrs];
	...
	public final edu.umn.cs.melt.ableC.abstractsyntax.NFunctionDecl getChild_d() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.NFunctionDecl) (child_d = common.Util.demand(child_d));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:gcc:functionDeclStmt erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:gcc:functionDeclStmt";
	}

	static void initProductionAttributeDefinitions() {
		// top.pp = d.pp
		edu.umn.cs.melt.ableC.abstractsyntax.gcc.PfunctionDeclStmt.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_Stmt] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)context.childDecorated(edu.umn.cs.melt.ableC.abstractsyntax.gcc.PfunctionDeclStmt.i_d).synthesized(edu.umn.cs.melt.ableC.abstractsyntax.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_FunctionDecl)); } };
		// top.errors := d.errors
		if(edu.umn.cs.melt.ableC.abstractsyntax.gcc.PfunctionDeclStmt.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_Stmt] == null)
