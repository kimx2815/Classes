...
public final class PaugmentScope_i extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_d, final Object c_s) {
		...
		return (common.ConsCell)(((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)silver.util.raw.treemap.Padd.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PaugmentScope_i.i_d), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PaugmentScope_i.i_s))); } })); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PaugmentScope_i.i_s))); } })));
