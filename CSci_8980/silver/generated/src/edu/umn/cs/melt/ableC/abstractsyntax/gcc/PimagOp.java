...
// top::UnaryOp ::= 
public final class PimagOp extends edu.umn.cs.melt.ableC.abstractsyntax.NUnaryOp {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_gcc_imagOp;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:gcc:imagOp erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:gcc:imagOp";
	}

	static void initProductionAttributeDefinitions() {
		// top.pp = text("__imag__",)
		edu.umn.cs.melt.ableC.abstractsyntax.gcc.PimagOp.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.Init.silver_langutil_pp__ON__edu_umn_cs_melt_ableC_abstractsyntax_UnaryOp] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext((new common.StringCatter("__imag__")))); } };
		// top.preExpr = true
		edu.umn.cs.melt.ableC.abstractsyntax.gcc.PimagOp.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.Init.edu_umn_cs_melt_ableC_abstractsyntax_preExpr__ON__edu_umn_cs_melt_ableC_abstractsyntax_UnaryOp] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return true; } };
