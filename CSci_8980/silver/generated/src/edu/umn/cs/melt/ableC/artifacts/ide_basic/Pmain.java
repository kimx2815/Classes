...
public final class Pmain extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_artifacts_ide_basic_main;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:artifacts:ide_basic:main";
	}
	...
	public static core.NIOVal invoke(final Object c_args, final Object c_io_in) {
		...
		return (core.NIOVal)(((core.NIOVal)edu.umn.cs.melt.ableC.drivers.parseOnly.Pdriver.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.artifacts.ide_basic.Pmain.i_args), context.childAsIsLazy(edu.umn.cs.melt.ableC.artifacts.ide_basic.Pmain.i_io_in), edu.umn.cs.melt.ableC.artifacts.ide_basic.PtheParser.factory)));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:artifacts:ide_basic:main", t);
		}
	}
