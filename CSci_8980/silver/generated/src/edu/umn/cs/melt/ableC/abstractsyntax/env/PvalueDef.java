...
public final class PvalueDef extends edu.umn.cs.melt.ableC.abstractsyntax.env.NDef {
	...
	static void initProductionAttributeDefinitions() {
		...
		edu.umn.cs.melt.ableC.abstractsyntax.env.PvalueDef.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.env.Init.edu_umn_cs_melt_ableC_abstractsyntax_env_valueContribs__ON__edu_umn_cs_melt_ableC_abstractsyntax_env_Def] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((core.NPair)new core.Ppair(context.childAsIsLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PvalueDef.i_s), common.Thunk.transformUndecorate(context.childDecoratedLazy(edu.umn.cs.melt.ableC.abstractsyntax.env.PvalueDef.i_l)))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } })); } };
