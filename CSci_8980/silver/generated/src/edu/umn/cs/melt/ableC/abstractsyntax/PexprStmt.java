...
// top::Stmt ::= d::Expr 
public final class PexprStmt extends edu.umn.cs.melt.ableC.abstractsyntax.NStmt {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_exprStmt;
	...
	static {
	childInheritedAttributes[i_d] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.NExpr.num_inh_attrs];
	...
	public final edu.umn.cs.melt.ableC.abstractsyntax.NExpr getChild_d() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.NExpr) (child_d = common.Util.demand(child_d));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:exprStmt erroneously claimed to forward");
	}
