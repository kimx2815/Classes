...
public final class PwarnExternalDecl extends edu.umn.cs.melt.ableC.abstractsyntax.NExternalDecl {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_warnExternalDecl;
	...
	public PwarnExternalDecl(final Object c_msg) {
		super();
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:warnExternalDecl erroneously claimed to forward");
	}
	...
	public static final common.NodeFactory<PwarnExternalDecl> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PwarnExternalDecl> {

		@Override
		public PwarnExternalDecl invoke(final Object[] children, final Object[] annotations) {
			return new PwarnExternalDecl(children[0]);
		}
	};
