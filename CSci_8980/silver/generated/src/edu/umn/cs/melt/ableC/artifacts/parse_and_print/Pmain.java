...
public final class Pmain extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_artifacts_parse_and_print_main;
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:artifacts:parse_and_print:main";
	}
	...
	public static core.NIOVal invoke(final Object c_args, final Object c_io_in) {
		...
		return (core.NIOVal)(((core.NIOVal)edu.umn.cs.melt.ableC.drivers.parseAndPrint.Pdriver.invoke(context.childAsIsLazy(edu.umn.cs.melt.ableC.artifacts.parse_and_print.Pmain.i_args), context.childAsIsLazy(edu.umn.cs.melt.ableC.artifacts.parse_and_print.Pmain.i_io_in), edu.umn.cs.melt.ableC.artifacts.parse_and_print.PtheParser.factory)));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function edu:umn:cs:melt:ableC:artifacts:parse_and_print:main", t);
		}
	}
