...
public final class PP_edu_umn_cs_melt_ableC_concretesyntax_gcc_extsVariableAttributes_sv_18_0 extends edu.umn.cs.melt.ableC.concretesyntax.gcc_exts.NAttribute_c {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_concretesyntax_gcc_exts_P_edu_umn_cs_melt_ableC_concretesyntax_gcc_extsVariableAttributes_sv_18_0;
	...
	public PP_edu_umn_cs_melt_ableC_concretesyntax_gcc_extsVariableAttributes_sv_18_0(final Object c__G_5, final Object c__G_4, final Object c__G_3, final Object c_a, final Object c__G_1, final Object c__G_0, final Object a_core_location) {
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:concretesyntax:gcc_exts:P_edu_umn_cs_melt_ableC_concretesyntax_gcc_extsVariableAttributes_sv_18_0 erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:concretesyntax:gcc_exts:P_edu_umn_cs_melt_ableC_concretesyntax_gcc_extsVariableAttributes_sv_18_0";
	}
	...
	public static final common.NodeFactory<PP_edu_umn_cs_melt_ableC_concretesyntax_gcc_extsVariableAttributes_sv_18_0> factory = new Factory();

	public static final class Factory extends common.NodeFactory<PP_edu_umn_cs_melt_ableC_concretesyntax_gcc_extsVariableAttributes_sv_18_0> {

		@Override
		public PP_edu_umn_cs_melt_ableC_concretesyntax_gcc_extsVariableAttributes_sv_18_0 invoke(final Object[] children, final Object[] annotations) {
			return new PP_edu_umn_cs_melt_ableC_concretesyntax_gcc_extsVariableAttributes_sv_18_0(children[0], children[1], children[2], children[3], children[4], children[5], annotations[0]);
		}
	};
