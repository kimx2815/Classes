...
public final class PcomplexIntegerType extends edu.umn.cs.melt.ableC.abstractsyntax.NBuiltinType {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_complexIntegerType;
	...
	static {
	childInheritedAttributes[i_rt] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.NIntegerType.num_inh_attrs];

	}

	public PcomplexIntegerType(final Object c_rt) {
		super();
		this.child_rt = c_rt;
	...
	public final edu.umn.cs.melt.ableC.abstractsyntax.NIntegerType getChild_rt() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.NIntegerType) (child_rt = common.Util.demand(child_rt));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:complexIntegerType erroneously claimed to forward");
	}
