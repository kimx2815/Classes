...
public final class PderefMemberDesignator extends edu.umn.cs.melt.ableC.abstractsyntax.gcc.NMemberDesignator {
	...
	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_gcc_derefMemberDesignator;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:gcc:derefMemberDesignator erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:gcc:derefMemberDesignator";
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		// top.errors := d.errors
		if(edu.umn.cs.melt.ableC.abstractsyntax.gcc.PderefMemberDesignator.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.gcc.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_gcc_MemberDesignator] == null)
