...
// top::Parameters ::= 
public final class PnilParameters extends edu.umn.cs.melt.ableC.abstractsyntax.NParameters {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_nilParameters;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:nilParameters erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:nilParameters";
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		// top.errors := []
		if(edu.umn.cs.melt.ableC.abstractsyntax.PnilParameters.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.Init.silver_langutil_errors__ON__edu_umn_cs_melt_ableC_abstractsyntax_Parameters] == null)
