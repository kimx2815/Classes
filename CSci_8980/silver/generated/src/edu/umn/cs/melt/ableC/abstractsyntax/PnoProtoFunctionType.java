...
// top::FunctionType ::= 
public final class PnoProtoFunctionType extends edu.umn.cs.melt.ableC.abstractsyntax.NFunctionType {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_noProtoFunctionType;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:noProtoFunctionType erroneously claimed to forward");
	}
	...
	public String getName() {
		return "edu:umn:cs:melt:ableC:abstractsyntax:noProtoFunctionType";
	}

	static void initProductionAttributeDefinitions() {
		// top.lpp = notext(,)
		edu.umn.cs.melt.ableC.abstractsyntax.PnoProtoFunctionType.synthesizedAttributes[edu.umn.cs.melt.ableC.abstractsyntax.Init.edu_umn_cs_melt_ableC_abstractsyntax_lpp__ON__edu_umn_cs_melt_ableC_abstractsyntax_FunctionType] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pnotext()); } };
		// top.rpp = text("()",)
