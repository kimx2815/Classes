...
public final class PenumTypeExpr extends edu.umn.cs.melt.ableC.abstractsyntax.NBaseTypeExpr {

	public static final int i_q = 0;
	public static final int i_def = 1;


	public static final Class<?> childTypes[] = {common.DecoratedNode.class,edu.umn.cs.melt.ableC.abstractsyntax.NEnumDecl.class};

	public static final int num_local_attrs = Init.count_local__ON__edu_umn_cs_melt_ableC_abstractsyntax_enumTypeExpr;
	...
	static {
	childInheritedAttributes[i_def] = new common.Lazy[edu.umn.cs.melt.ableC.abstractsyntax.NEnumDecl.num_inh_attrs];
	...
	public final edu.umn.cs.melt.ableC.abstractsyntax.NEnumDecl getChild_def() {
		return (edu.umn.cs.melt.ableC.abstractsyntax.NEnumDecl) (child_def = common.Util.demand(child_def));
	}
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production edu:umn:cs:melt:ableC:abstractsyntax:enumTypeExpr erroneously claimed to forward");
	}
