...
public final class Pthe_parser extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__lambda_calculus_artifacts_host_the_parser;
	...
	public Pthe_parser(final Object c_stringToParse, final Object c_filenameToReport) {
	...
	public String getName() {
		return "lambda_calculus:artifacts:host:the_parser";
	}

	public static core.NParseResult invoke(final Object c_stringToParse, final Object c_filenameToReport) {
		try {
		try {
			return new core.PparseSucceeded( new lambda_calculus.artifacts.host.Parser_lambda_calculus_artifacts_host_the_parser().parse(new java.io.StringReader(((common.StringCatter)common.Util.demand(c_stringToParse)).toString()), ((common.StringCatter)common.Util.demand(c_filenameToReport)).toString()) );
			...
			throw new common.exceptions.TraceException("Error while evaluating function lambda_calculus:artifacts:host:the_parser", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NParseResult> {
		...
		public core.NParseResult invoke(final Object[] children, final Object[] namedNotApplicable) {
			return Pthe_parser.invoke(children[0], children[1]);
		}
	};
}