...
// t::Type ::= 
public final class PintegerType extends lambda_calculus.host.abstractsyntax.NType {



	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__lambda_calculus_host_abstractsyntax_integerType;
	...
	public common.Node evalForward(final common.DecoratedNode context) {
		throw new common.exceptions.SilverInternalError("Production lambda_calculus:host:abstractsyntax:integerType erroneously claimed to forward");
	}
	...
	public String getName() {
		return "lambda_calculus:host:abstractsyntax:integerType";
	}

	static void initProductionAttributeDefinitions() {
		// t.pp = "Integer"
		lambda_calculus.host.abstractsyntax.PintegerType.synthesizedAttributes[lambda_calculus.host.abstractsyntax.Init.lambda_calculus_host_abstractsyntax_pp__ON__lambda_calculus_host_abstractsyntax_Type] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return (new common.StringCatter("Integer")); } };
		// t.errors := []
		if(lambda_calculus.host.abstractsyntax.PintegerType.synthesizedAttributes[lambda_calculus.host.abstractsyntax.Init.lambda_calculus_host_abstractsyntax_errors__ON__lambda_calculus_host_abstractsyntax_Type] == null)
