...
public final class PcopyTo extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__ide_copyTo;
	...
	public PcopyTo(final Object c_res, final Object c_path, final Object c_i) {
	...
	public static core.NIOVal invoke(final Object c_res, final Object c_path, final Object c_i) {
		try {
		return (core.NIOVal)edu.umn.cs.melt.ide.util.ProjectUtil.dispatchService(edu.umn.cs.melt.ide.util.ProjectUtil.RESOURCE_COPY_TO, ((Object)common.Util.demand(c_i)), ((Object)common.Util.demand(c_res)), ((common.StringCatter)common.Util.demand(c_path)));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function ide:copyTo", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NIOVal> {
		...
		public core.NIOVal invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PcopyTo.invoke(children[0], children[1], children[2]);
		}
	};
}