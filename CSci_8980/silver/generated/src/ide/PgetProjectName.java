...
public final class PgetProjectName extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__ide_getProjectName;
	...
	public PgetProjectName(final Object c_proj, final Object c_i) {
	...
	public static core.NIOVal invoke(final Object c_proj, final Object c_i) {
		try {
		return (core.NIOVal)edu.umn.cs.melt.ide.util.ProjectUtil.dispatchService(edu.umn.cs.melt.ide.util.ProjectUtil.PROJECT_GET_NAME, ((Object)common.Util.demand(c_i)), ((Object)common.Util.demand(c_proj)), null);

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function ide:getProjectName", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NIOVal> {
		...
		public core.NIOVal invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PgetProjectName.invoke(children[0], children[1]);
		}
	};
}