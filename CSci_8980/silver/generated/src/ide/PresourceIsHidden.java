...
public final class PresourceIsHidden extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__ide_resourceIsHidden;
	...
	public PresourceIsHidden(final Object c_res, final Object c_i) {
	...
	public String getName() {
		return "ide:resourceIsHidden";
	}

	public static core.NIOVal invoke(final Object c_res, final Object c_i) {
		try {
		return (core.NIOVal)edu.umn.cs.melt.ide.util.ProjectUtil.dispatchService(edu.umn.cs.melt.ide.util.ProjectUtil.RESOURCE_IS_HIDDEN, ((Object)common.Util.demand(c_i)), ((Object)common.Util.demand(c_res)), null);

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function ide:resourceIsHidden", t);
		}
	}
	...
	public static final class Factory extends common.NodeFactory<core.NIOVal> {
		...
		public core.NIOVal invoke(final Object[] children, final Object[] namedNotApplicable) {
			return PresourceIsHidden.invoke(children[0], children[1]);
		}
	};
}