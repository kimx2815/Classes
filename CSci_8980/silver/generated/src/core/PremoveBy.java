...
public final class PremoveBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_eq, final Object c_x, final Object c_xs) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PremoveBy.i_xs))) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.Pappend.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return (((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.PremoveBy.i_eq)).invoke(new Object[]{context.childAsIsLazy(core.PremoveBy.i_x), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PremoveBy.i_xs))); } }}, null)) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PremoveBy.i_xs))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } }))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PremoveBy.invoke(context.childAsIsLazy(core.PremoveBy.i_eq), context.childAsIsLazy(core.PremoveBy.i_x), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PremoveBy.i_xs))); } })); } }))));
