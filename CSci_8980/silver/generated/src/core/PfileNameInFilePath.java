...
public final class PfileNameInFilePath extends common.FunctionNode {
	...
	public static common.StringCatter invoke(final Object c_filePath) {
		...
		return (common.StringCatter)((((Integer)context.localAsIs(core.Init.indexOfLastSlash__ON__core_fileNameInFilePath)).equals(Integer.valueOf((int)-1)) ? ((common.StringCatter)context.childAsIs(core.PfileNameInFilePath.i_filePath)) : ((common.StringCatter)core.Psubstring.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((Integer)context.localAsIs(core.Init.indexOfLastSlash__ON__core_fileNameInFilePath)) + Integer.valueOf((int)1)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((common.StringCatter)((common.StringCatter)context.childAsIs(core.PfileNameInFilePath.i_filePath))).length()); } }, context.childAsIsLazy(core.PfileNameInFilePath.i_filePath)))));
