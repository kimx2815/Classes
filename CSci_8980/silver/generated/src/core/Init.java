...
public class Init{
	...
	private static void initProductionAttributeDefinitions(){
		...
		core.Ppartition.localAttributes[core.Init.recurse__ON__core_partition] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((core.NPair)core.Ppartition.invoke(context.childAsIsLazy(core.Ppartition.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Ppartition.i_lst))); } })); } };
		...
		core.PsortByHelp.localAttributes[core.Init.back_half__ON__core_sortByHelp] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.PsortByHelp.invoke(context.childAsIsLazy(core.PsortByHelp.i_lte), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pdrop.invoke(context.localAsIsLazy(core.Init.middle__ON__core_sortByHelp), context.childAsIsLazy(core.PsortByHelp.i_lst))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((Integer)context.childAsIs(core.PsortByHelp.i_upTo)) - ((Integer)context.localAsIs(core.Init.middle__ON__core_sortByHelp))); } })); } };
		...
		core.PgroupBy.localAttributes[core.Init.helpercall__ON__core_groupBy] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((core.NPair)core.PgroupByHelp.invoke(context.childAsIsLazy(core.PgroupBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PgroupBy.i_l))); } }, context.childAsIsLazy(core.PgroupBy.i_l))); } };
		//FUNCTION groupByHelp Pair<[a] [a]> ::= eq::(Boolean ::= a a) f::a l::[a] 
		// recurse = groupByHelp(eq, f, tail(l,),)
		core.PgroupByHelp.localAttributes[core.Init.recurse__ON__core_groupByHelp] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((core.NPair)core.PgroupByHelp.invoke(context.childAsIsLazy(core.PgroupByHelp.i_eq), context.childAsIsLazy(core.PgroupByHelp.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PgroupByHelp.i_l))); } })); } };
