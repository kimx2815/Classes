...
public final class Pdrop extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_number, final Object c_lst) {
		...
		return (common.ConsCell)(((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.Pdrop.i_lst))) || (((Integer)context.childAsIs(core.Pdrop.i_number)) <= Integer.valueOf((int)0))) ? ((common.ConsCell)context.childAsIs(core.Pdrop.i_lst)) : ((common.ConsCell)core.Pdrop.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((Integer)context.childAsIs(core.Pdrop.i_number)) - Integer.valueOf((int)1)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pdrop.i_lst))); } }))));
