...
public final class Preverse extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_lst) {
		...
		//reverseHelp(lst, [],)
		return (common.ConsCell)(((common.ConsCell)core.PreverseHelp.invoke(context.childAsIsLazy(core.Preverse.i_lst), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } })));
