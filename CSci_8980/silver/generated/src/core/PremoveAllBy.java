...
public final class PremoveAllBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_eq, final Object c_ys, final Object c_xs) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PremoveAllBy.i_ys))) ? ((common.ConsCell)context.childAsIs(core.PremoveAllBy.i_xs)) : ((common.ConsCell)core.PremoveAllBy.invoke(context.childAsIsLazy(core.PremoveAllBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PremoveAllBy.i_ys))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PremoveBy.invoke(context.childAsIsLazy(core.PremoveAllBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PremoveAllBy.i_ys))); } }, context.childAsIsLazy(core.PremoveAllBy.i_xs))); } }))));
