...
public final class PparseTreeOrDieWithoutStackTrace extends common.FunctionNode {
	...
	public static Object invoke(final Object c_pr) {
		...
		return (Object)(((Object)core.PunsafeTrace.invoke(context.childDecoratedSynthesizedLazy(core.PparseTreeOrDieWithoutStackTrace.i_pr, core.Init.core_parseTree__ON__core_ParseResult), new common.Thunk<Object>(context) { public final Object doEval() { return (((Boolean)context.childDecorated(core.PparseTreeOrDieWithoutStackTrace.i_pr).synthesized(core.Init.core_parseSuccess__ON__core_ParseResult)) ? ((Object)core.PunsafeIO.invoke()) : ((Object)core.Pexit.invoke(Integer.valueOf((int)-1), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Pprint.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return new common.StringCatter((common.StringCatter)((common.StringCatter)context.childDecorated(core.PparseTreeOrDieWithoutStackTrace.i_pr).synthesized(core.Init.core_parseErrors__ON__core_ParseResult)), (common.StringCatter)(new common.StringCatter("\n\n"))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.PunsafeIO.invoke()); } })); } }))); } })));
