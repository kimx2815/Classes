...
public final class Pfoldl extends common.FunctionNode {
	...
	public static Object invoke(final Object c_f, final Object c_i, final Object c_l) {
		...
		return (Object)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.Pfoldl.i_l))) ? ((Object)context.childAsIs(core.Pfoldl.i_i)) : ((Object)core.Pfoldl.invoke(context.childAsIsLazy(core.Pfoldl.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)((common.NodeFactory<Object>)context.childAsIs(core.Pfoldl.i_f)).invoke(new Object[]{context.childAsIsLazy(core.Pfoldl.i_i), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.Pfoldl.i_l))); } }}, null)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pfoldl.i_l))); } }))));
