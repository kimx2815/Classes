...
public final class Pintersperse extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_sep, final Object c_xs) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.Pintersperse.i_xs))) ? ((common.ConsCell)core.Pnil.invoke()) : (((Boolean)core.Pnull.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pintersperse.i_xs))); } })) ? ((common.ConsCell)context.childAsIs(core.Pintersperse.i_xs)) : ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.Pintersperse.i_xs))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pcons.invoke(context.childAsIsLazy(core.Pintersperse.i_sep), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pintersperse.invoke(context.childAsIsLazy(core.Pintersperse.i_sep), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pintersperse.i_xs))); } })); } })); } })))));
