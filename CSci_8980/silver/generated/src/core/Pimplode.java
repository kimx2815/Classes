...
public final class Pimplode extends common.FunctionNode {
	...
	public static common.StringCatter invoke(final Object c_sep, final Object c_lst) {
		...
		return (common.StringCatter)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.Pimplode.i_lst))) ? (new common.StringCatter("")) : new common.StringCatter((common.StringCatter)((common.StringCatter)core.Phead.invoke(context.childAsIsLazy(core.Pimplode.i_lst))), (common.StringCatter)(((Boolean)core.Pnull.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pimplode.i_lst))); } })) ? (new common.StringCatter("")) : new common.StringCatter((common.StringCatter)((common.StringCatter)context.childAsIs(core.Pimplode.i_sep)), (common.StringCatter)((common.StringCatter)core.Pimplode.invoke(context.childAsIsLazy(core.Pimplode.i_sep), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pimplode.i_lst))); } })))))));
