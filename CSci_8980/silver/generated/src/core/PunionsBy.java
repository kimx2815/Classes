...
public final class PunionsBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_eq, final Object c_ss) {
		...
		return (common.ConsCell)(((common.ConsCell)core.PnubBy.invoke(context.childAsIsLazy(core.PunionsBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pfoldr.invoke(core.Pappend.factory, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } }, context.childAsIsLazy(core.PunionsBy.i_ss))); } })));
