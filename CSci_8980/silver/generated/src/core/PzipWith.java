...
public final class PzipWith extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_f, final Object c_l1, final Object c_l2) {
		...
		return (common.ConsCell)(((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PzipWith.i_l1))) || ((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PzipWith.i_l2)))) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)((common.NodeFactory<Object>)context.childAsIs(core.PzipWith.i_f)).invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PzipWith.i_l1))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PzipWith.i_l2))); } }}, null)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PzipWith.invoke(context.childAsIsLazy(core.PzipWith.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PzipWith.i_l1))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PzipWith.i_l2))); } })); } }))));
