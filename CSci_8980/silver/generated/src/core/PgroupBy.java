...
public final class PgroupBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_eq, final Object c_l) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PgroupBy.i_l))) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)context.localDecorated(core.Init.helpercall__ON__core_groupBy).synthesized(core.Init.core_fst__ON__core_Pair)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return (((Boolean)core.Pnull.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)context.localDecorated(core.Init.helpercall__ON__core_groupBy).synthesized(core.Init.core_snd__ON__core_Pair)); } })) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.PgroupBy.invoke(context.childAsIsLazy(core.PgroupBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)context.localDecorated(core.Init.helpercall__ON__core_groupBy).synthesized(core.Init.core_snd__ON__core_Pair)); } }))); } }))));
