...
public final class Pfoldr1 extends common.FunctionNode {
	...
	public static Object invoke(final Object c_f, final Object c_l) {
		...
		return (Object)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.Pfoldr1.i_l))) ? ((Object)core.Perror.invoke((new common.StringCatter("Applying foldr1 to empty list.")))) : (((Boolean)core.Pnull.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pfoldr1.i_l))); } })) ? ((Object)core.Phead.invoke(context.childAsIsLazy(core.Pfoldr1.i_l))) : ((Object)((common.NodeFactory<Object>)context.childAsIs(core.Pfoldr1.i_f)).invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.Pfoldr1.i_l))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Pfoldr1.invoke(context.childAsIsLazy(core.Pfoldr1.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pfoldr1.i_l))); } })); } }}, null)))));
