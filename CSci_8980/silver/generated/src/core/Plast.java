...
public final class Plast extends common.FunctionNode {
	...
	public static Object invoke(final Object c_lst) {
		...
		return (Object)((((Boolean)core.Pnull.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Plast.i_lst))); } })) ? ((Object)core.Phead.invoke(context.childAsIsLazy(core.Plast.i_lst))) : ((Object)core.Plast.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Plast.i_lst))); } }))));
