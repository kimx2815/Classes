...
public final class PsplitFileNameAndExtension extends common.FunctionNode {
	...
	public static core.NPair invoke(final Object c_filePath) {
		...
		return (core.NPair)((((Integer)context.localAsIs(core.Init.indexOfLastDot__ON__core_splitFileNameAndExtension)).equals(Integer.valueOf((int)-1)) ? ((core.NPair)new core.Ppair(context.childAsIsLazy(core.PsplitFileNameAndExtension.i_filePath), (new common.StringCatter("")))) : ((core.NPair)new core.Ppair(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.StringCatter)core.Psubstring.invoke(Integer.valueOf((int)0), context.localAsIsLazy(core.Init.indexOfLastDot__ON__core_splitFileNameAndExtension), context.childAsIsLazy(core.PsplitFileNameAndExtension.i_filePath))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.StringCatter)core.Psubstring.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((Integer)context.localAsIs(core.Init.indexOfLastDot__ON__core_splitFileNameAndExtension)) + Integer.valueOf((int)1)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((common.StringCatter)((common.StringCatter)context.childAsIs(core.PsplitFileNameAndExtension.i_filePath))).length()); } }, context.childAsIsLazy(core.PsplitFileNameAndExtension.i_filePath))); } }))));
