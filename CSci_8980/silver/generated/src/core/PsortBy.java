...
public final class PsortBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_lte, final Object c_lst) {
		...
		return (common.ConsCell)(((common.ConsCell)core.PsortByHelp.invoke(context.childAsIsLazy(core.PsortBy.i_lte), context.childAsIsLazy(core.PsortBy.i_lst), new common.Thunk<Object>(context) { public final Object doEval() { return ((Integer)core.PlistLength.invoke(context.childAsIsLazy(core.PsortBy.i_lst))); } })));
