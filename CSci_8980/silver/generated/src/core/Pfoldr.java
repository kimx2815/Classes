...
public final class Pfoldr extends common.FunctionNode {
	...
	public static Object invoke(final Object c_f, final Object c_i, final Object c_l) {
		...
		return (Object)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.Pfoldr.i_l))) ? ((Object)context.childAsIs(core.Pfoldr.i_i)) : ((Object)((common.NodeFactory<Object>)context.childAsIs(core.Pfoldr.i_f)).invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.Pfoldr.i_l))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Pfoldr.invoke(context.childAsIsLazy(core.Pfoldr.i_f), context.childAsIsLazy(core.Pfoldr.i_i), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pfoldr.i_l))); } })); } }}, null))));
