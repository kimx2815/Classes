...
public final class PnubBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_eq, final Object c_xs) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PnubBy.i_xs))) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PnubBy.i_xs))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PnubBy.invoke(context.childAsIsLazy(core.PnubBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PremoveBy.invoke(context.childAsIsLazy(core.PnubBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PnubBy.i_xs))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PnubBy.i_xs))); } })); } })); } }))));
