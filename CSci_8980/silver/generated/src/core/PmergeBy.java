...
public final class PmergeBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_lte, final Object c_l1, final Object c_l2) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PmergeBy.i_l1))) ? ((common.ConsCell)context.childAsIs(core.PmergeBy.i_l2)) : (((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PmergeBy.i_l2))) ? ((common.ConsCell)context.childAsIs(core.PmergeBy.i_l1)) : (((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.PmergeBy.i_lte)).invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PmergeBy.i_l1))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PmergeBy.i_l2))); } }}, null)) ? ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PmergeBy.i_l1))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PmergeBy.invoke(context.childAsIsLazy(core.PmergeBy.i_lte), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PmergeBy.i_l1))); } }, context.childAsIsLazy(core.PmergeBy.i_l2))); } })) : ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PmergeBy.i_l2))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PmergeBy.invoke(context.childAsIsLazy(core.PmergeBy.i_lte), context.childAsIsLazy(core.PmergeBy.i_l1), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PmergeBy.i_l2))); } })); } }))))));
