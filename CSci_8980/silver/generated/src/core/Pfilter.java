...
public final class Pfilter extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_f, final Object c_lst) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.Pfilter.i_lst))) ? ((common.ConsCell)core.Pnil.invoke()) : (((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.Pfilter.i_f)).invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.Pfilter.i_lst))); } }}, null)) ? ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.Pfilter.i_lst))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pfilter.invoke(context.childAsIsLazy(core.Pfilter.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pfilter.i_lst))); } })); } })) : ((common.ConsCell)core.Pfilter.invoke(context.childAsIsLazy(core.Pfilter.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.Pfilter.i_lst))); } })))));
