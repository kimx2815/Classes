...
public final class PexplodeSingle extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_str) {
		...
		return (common.ConsCell)((Integer.valueOf(((common.StringCatter)((common.StringCatter)context.childAsIs(core.PexplodeSingle.i_str))).length()).equals(Integer.valueOf((int)0)) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.StringCatter)core.Psubstring.invoke(Integer.valueOf((int)0), Integer.valueOf((int)1), context.childAsIsLazy(core.PexplodeSingle.i_str))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PexplodeSingle.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.StringCatter)core.Psubstring.invoke(Integer.valueOf((int)1), new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((common.StringCatter)((common.StringCatter)context.childAsIs(core.PexplodeSingle.i_str))).length()); } }, context.childAsIsLazy(core.PexplodeSingle.i_str))); } })); } }))));
