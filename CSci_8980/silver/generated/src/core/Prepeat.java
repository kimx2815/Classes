...
public final class Prepeat extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_v, final Object c_times) {
		...
		return (common.ConsCell)(((((Integer)context.childAsIs(core.Prepeat.i_times)) <= Integer.valueOf((int)0)) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.Pcons.invoke(context.childAsIsLazy(core.Prepeat.i_v), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Prepeat.invoke(context.childAsIsLazy(core.Prepeat.i_v), new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((Integer)context.childAsIs(core.Prepeat.i_times)) - Integer.valueOf((int)1)); } })); } }))));
