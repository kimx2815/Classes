...
public final class PgroupByHelp extends common.FunctionNode {
	...
	public static core.NPair invoke(final Object c_eq, final Object c_f, final Object c_l) {
		...
		return (core.NPair)(((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PgroupByHelp.i_l))) || (!((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.PgroupByHelp.i_eq)).invoke(new Object[]{context.childAsIsLazy(core.PgroupByHelp.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PgroupByHelp.i_l))); } }}, null)))) ? ((core.NPair)new core.Ppair(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } }, context.childAsIsLazy(core.PgroupByHelp.i_l))) : ((core.NPair)new core.Ppair(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PgroupByHelp.i_l))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)context.localDecorated(core.Init.recurse__ON__core_groupByHelp).synthesized(core.Init.core_fst__ON__core_Pair)); } })); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)context.localDecorated(core.Init.recurse__ON__core_groupByHelp).synthesized(core.Init.core_snd__ON__core_Pair)); } }))));
