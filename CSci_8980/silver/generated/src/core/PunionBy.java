...
public final class PunionBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_eq, final Object c_l, final Object c_r) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PunionBy.i_l))) ? ((common.ConsCell)context.childAsIs(core.PunionBy.i_r)) : ((common.ConsCell)core.Pappend.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return (((Boolean)core.PcontainsBy.invoke(context.childAsIsLazy(core.PunionBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PunionBy.i_l))); } }, context.childAsIsLazy(core.PunionBy.i_r))) ? ((common.ConsCell)core.Pnil.invoke()) : ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PunionBy.i_l))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } }))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PunionBy.invoke(context.childAsIsLazy(core.PunionBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PunionBy.i_l))); } }, context.childAsIsLazy(core.PunionBy.i_r))); } }))));
