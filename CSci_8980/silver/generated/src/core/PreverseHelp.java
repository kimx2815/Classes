...
public final class PreverseHelp extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object c_lst, final Object c_sofar) {
		...
		return (common.ConsCell)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PreverseHelp.i_lst))) ? ((common.ConsCell)context.childAsIs(core.PreverseHelp.i_sofar)) : ((common.ConsCell)core.PreverseHelp.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PreverseHelp.i_lst))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(context.childAsIsLazy(core.PreverseHelp.i_lst))); } }, context.childAsIsLazy(core.PreverseHelp.i_sofar))); } }))));
