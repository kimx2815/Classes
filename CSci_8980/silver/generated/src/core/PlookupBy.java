...
public final class PlookupBy extends common.FunctionNode {
	...
	public static core.NMaybe invoke(final Object c_eqf, final Object c_elem, final Object c_lst) {
		...
		return (core.NMaybe)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(core.PlookupBy.i_lst))) ? ((core.NMaybe)new core.Pnothing()) : (((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.PlookupBy.i_eqf)).invoke(new Object[]{context.childAsIsLazy(core.PlookupBy.i_elem), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)((core.NPair)core.Phead.invoke(context.childAsIsLazy(core.PlookupBy.i_lst))).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_fst__ON__core_Pair)); } }}, null)) ? ((core.NMaybe)new core.Pjust(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)((core.NPair)core.Phead.invoke(context.childAsIsLazy(core.PlookupBy.i_lst))).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_snd__ON__core_Pair)); } })) : ((core.NMaybe)core.PlookupBy.invoke(context.childAsIsLazy(core.PlookupBy.i_eqf), context.childAsIsLazy(core.PlookupBy.i_elem), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(core.PlookupBy.i_lst))); } })))));
