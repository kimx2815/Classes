...
public final class Pconcat extends common.FunctionNode {
	...
	public static silver.langutil.pp.NDocument invoke(final Object c_ds) {
		try {
		final common.DecoratedNode context = new Pconcat(c_ds).decorate();
		//if null(ds,) then notext(,) else foldl(cat, head(ds,), tail(ds,),)
		return (silver.langutil.pp.NDocument)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(silver.langutil.pp.Pconcat.i_ds))) ? ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pnotext()) : ((silver.langutil.pp.NDocument)core.Pfoldl.invoke(silver.langutil.pp.Pcat.factory, new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.langutil.pp.NDocument)core.Phead.invoke(context.childAsIsLazy(silver.langutil.pp.Pconcat.i_ds))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(silver.langutil.pp.Pconcat.i_ds))); } }))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:langutil:pp:concat", t);
		}
	}
