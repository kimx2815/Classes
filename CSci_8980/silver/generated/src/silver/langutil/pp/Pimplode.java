...
public final class Pimplode extends common.FunctionNode {
	...
	public static silver.langutil.pp.NDocument invoke(final Object c_sep, final Object c_ds) {
		try {
		final common.DecoratedNode context = new Pimplode(c_sep, c_ds).decorate();
		//if null(ds,) then notext(,) else if null(tail(ds,),) then head(ds,) else cat(cat(head(ds,), sep,), implode(sep, tail(ds,),),)
		return (silver.langutil.pp.NDocument)((((Boolean)core.Pnull.invoke(context.childAsIsLazy(silver.langutil.pp.Pimplode.i_ds))) ? ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pnotext()) : (((Boolean)core.Pnull.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(silver.langutil.pp.Pimplode.i_ds))); } })) ? ((silver.langutil.pp.NDocument)core.Phead.invoke(context.childAsIsLazy(silver.langutil.pp.Pimplode.i_ds))) : ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.langutil.pp.NDocument)core.Phead.invoke(context.childAsIsLazy(silver.langutil.pp.Pimplode.i_ds))); } }, common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pimplode.i_sep)))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.langutil.pp.NDocument)silver.langutil.pp.Pimplode.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pimplode.i_sep)), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childAsIsLazy(silver.langutil.pp.Pimplode.i_ds))); } })); } })))));

		} catch(Throwable t) {
			throw new common.exceptions.TraceException("Error while evaluating function silver:langutil:pp:implode", t);
		}
	}
