...
public final class Pprune extends common.FunctionNode {
	...
	public static core.NPair invoke(final Object c_p, final Object c_q) {
		...
		return (core.NPair)((((Boolean)silver.util.deque.PdqIsEmpty.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pprune.i_q)))) ? ((core.NPair)new core.Ppair(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pprune.i_q)), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } })) : ((core.NPair)(new common.Thunk<Object>(context) { public final Object doEval() { final common.Thunk<Object> __SV_LOCAL_h = new common.Thunk<Object>(context) { public final Object doEval() { return ((core.NPair)silver.util.deque.PdqHead.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pprune.i_q)))); } };
return ((((Integer)context.childAsIs(silver.langutil.pp.Pprune.i_p)) <= ((Integer)((core.NPair)(__SV_LOCAL_h.eval())).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_fst__ON__core_Pair))) ? ((core.NPair)new core.Ppair(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pprune.i_q)), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } })) : ((core.NPair)(new common.Thunk<Object>(context) { public final Object doEval() { final common.Thunk<Object> __SV_LOCAL_recur = new common.Thunk<Object>(context) { public final Object doEval() { return ((core.NPair)silver.langutil.pp.Pprune.invoke(context.childAsIsLazy(silver.langutil.pp.Pprune.i_p), new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.util.deque.NDeque)silver.util.deque.PdqTail.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pprune.i_q)))); } })); } };
return ((core.NPair)new core.Ppair(new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.util.deque.NDeque)((core.NPair)(__SV_LOCAL_recur.eval())).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_fst__ON__core_Pair)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pcons.invoke(false, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pappend.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)((core.NPair)(__SV_LOCAL_h.eval())).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_snd__ON__core_Pair)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)((core.NPair)(__SV_LOCAL_recur.eval())).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_snd__ON__core_Pair)); } })); } })); } })); } }).eval())); } }).eval())));
