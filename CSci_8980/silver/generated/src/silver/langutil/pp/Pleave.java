...
public final class Pleave extends common.FunctionNode {
	...
	public static core.NPair invoke(final Object c_p, final Object c_q) {
		...
		return (core.NPair)((((Boolean)silver.util.deque.PdqIsEmpty.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pleave.i_q)))) ? ((core.NPair)new core.Ppair(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pleave.i_q)), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } })) : ((core.NPair)(new common.Thunk<Object>(context) { public final Object doEval() { final common.Thunk<Object> __SV_LOCAL_h1 = new common.Thunk<Object>(context) { public final Object doEval() { return ((core.NPair)silver.util.deque.PdqLast.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pleave.i_q)))); } };
final common.Thunk<Object> __SV_LOCAL_t1 = new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.util.deque.NDeque)silver.util.deque.PdqInit.invoke(common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pleave.i_q)))); } };
return (((Boolean)silver.util.deque.PdqIsEmpty.invoke(__SV_LOCAL_t1)) ? ((core.NPair)new core.Ppair(__SV_LOCAL_t1, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pcons.invoke(true, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)((core.NPair)(__SV_LOCAL_h1.eval())).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_snd__ON__core_Pair)); } })); } })) : ((core.NPair)(new common.Thunk<Object>(context) { public final Object doEval() { final common.Thunk<Object> __SV_LOCAL_h2 = new common.Thunk<Object>(context) { public final Object doEval() { return ((core.NPair)silver.util.deque.PdqLast.invoke(__SV_LOCAL_t1)); } };
final common.Thunk<Object> __SV_LOCAL_t2 = new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.util.deque.NDeque)silver.util.deque.PdqInit.invoke(__SV_LOCAL_t1)); } };
return ((core.NPair)new core.Ppair(new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.util.deque.NDeque)silver.util.deque.PdqSnoc.invoke(__SV_LOCAL_t2, new common.Thunk<Object>(context) { public final Object doEval() { return ((core.NPair)new core.Ppair(new common.Thunk<Object>(context) { public final Object doEval() { return ((Integer)((core.NPair)(__SV_LOCAL_h2.eval())).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_fst__ON__core_Pair)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pappend.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)((core.NPair)(__SV_LOCAL_h2.eval())).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_snd__ON__core_Pair)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pappend.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return (((Integer)context.childAsIs(silver.langutil.pp.Pleave.i_p)) <= ((Integer)((core.NPair)(__SV_LOCAL_h1.eval())).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_fst__ON__core_Pair))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } })); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)((core.NPair)(__SV_LOCAL_h1.eval())).decorate(context, (common.Lazy[])null).synthesized(core.Init.core_snd__ON__core_Pair)); } })); } })); } })); } })); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke()); } })); } }).eval())); } }).eval())));
