...
public final class Pgroup extends silver.langutil.pp.NDocument {
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.langutil.pp.Pgroup.synthesizedAttributes[silver.langutil.pp.Init.silver_langutil_pp_outCHorizontals__ON__silver_langutil_pp_Document] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pcons.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((Boolean)core.Phead.invoke(context.contextInheritedLazy(silver.langutil.pp.Init.silver_langutil_pp_inCHorizontals__ON__silver_langutil_pp_Document))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(context.childDecoratedSynthesizedLazy(silver.langutil.pp.Pgroup.i_d, silver.langutil.pp.Init.silver_langutil_pp_outCHorizontals__ON__silver_langutil_pp_Document))); } })); } };
		...
		silver.langutil.pp.Pgroup.synthesizedAttributes[silver.langutil.pp.Init.silver_langutil_pp_horizontals__ON__silver_langutil_pp_Document] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pappend.invoke(context.childDecoratedSynthesizedLazy(silver.langutil.pp.Pgroup.i_d, silver.langutil.pp.Init.silver_langutil_pp_horizontals__ON__silver_langutil_pp_Document), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)context.localDecorated(silver.langutil.pp.Init.le__ON__silver_langutil_pp_group).synthesized(core.Init.core_snd__ON__core_Pair)); } })); } };
