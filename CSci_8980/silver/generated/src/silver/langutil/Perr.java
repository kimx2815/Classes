...
public final class Perr extends silver.langutil.NMessage {
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.langutil.Perr.synthesizedAttributes[silver.langutil.Init.silver_langutil_output__ON__silver_langutil_Message] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return new common.StringCatter((common.StringCatter)((common.StringCatter)context.childDecorated(silver.langutil.Perr.i_l).synthesized(core.Init.core_filename__ON__core_Location)), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter(":")), (common.StringCatter)new common.StringCatter((common.StringCatter)new common.StringCatter(String.valueOf(((Integer)context.childDecorated(silver.langutil.Perr.i_l).synthesized(core.Init.core_line__ON__core_Location)))), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter(":")), (common.StringCatter)new common.StringCatter((common.StringCatter)new common.StringCatter(String.valueOf(((Integer)context.childDecorated(silver.langutil.Perr.i_l).synthesized(core.Init.core_column__ON__core_Location)))), (common.StringCatter)new common.StringCatter((common.StringCatter)(new common.StringCatter(": error: ")), (common.StringCatter)((common.StringCatter)context.childAsIs(silver.langutil.Perr.i_m)))))))); } };
		// top.severity = 0
		silver.langutil.Perr.synthesizedAttributes[silver.langutil.Init.silver_langutil_severity__ON__silver_langutil_Message] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return Integer.valueOf((int)0); } };
