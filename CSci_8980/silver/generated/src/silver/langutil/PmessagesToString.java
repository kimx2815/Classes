...
public final class PmessagesToString extends common.FunctionNode {
	...
	public static common.StringCatter invoke(final Object c_msgs) {
		...
		return (common.StringCatter)(((common.StringCatter)core.Pimplode.invoke((new common.StringCatter("\n")), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pmap.invoke(new common.AttributeSection.Undecorated(silver.langutil.Init.silver_langutil_output__ON__silver_langutil_Message), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PsortBy.invoke(silver.langutil.PmessageLte.factory, context.childAsIsLazy(silver.langutil.PmessagesToString.i_msgs))); } })); } })));
