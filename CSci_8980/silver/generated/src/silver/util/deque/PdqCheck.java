...
public final class PdqCheck extends common.FunctionNode {
	...
	public static silver.util.deque.NDeque invoke(final Object c_lenf, final Object c_f, final Object c_lenr, final Object c_r) {
		...
		return (silver.util.deque.NDeque)(((((Integer)context.childAsIs(silver.util.deque.PdqCheck.i_lenf)) > Integer.valueOf(Integer.valueOf(Integer.valueOf((int)2) * ((Integer)context.childAsIs(silver.util.deque.PdqCheck.i_lenr))) + Integer.valueOf((int)1))) ? ((silver.util.deque.NDeque)(new common.Thunk<Object>(context) { public final Object doEval() { final common.Thunk<Object> __SV_LOCAL_fprime = new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptake.invoke(context.localAsIsLazy(silver.util.deque.Init.mid__ON__silver_util_deque_dqCheck), context.childAsIsLazy(silver.util.deque.PdqCheck.i_f))); } };
final common.Thunk<Object> __SV_LOCAL_rprime = new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pappend.invoke(context.childAsIsLazy(silver.util.deque.PdqCheck.i_r), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Preverse.invoke(new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pdrop.invoke(context.localAsIsLazy(silver.util.deque.Init.mid__ON__silver_util_deque_dqCheck), context.childAsIsLazy(silver.util.deque.PdqCheck.i_f))); } })); } })); } };
return ((silver.util.deque.NDeque)new silver.util.deque.Pdeque(context.localAsIsLazy(silver.util.deque.Init.mid__ON__silver_util_deque_dqCheck), __SV_LOCAL_fprime, context.localAsIsLazy(silver.util.deque.Init.rest__ON__silver_util_deque_dqCheck), __SV_LOCAL_rprime)); } }).eval()) : ((((Integer)context.childAsIs(silver.util.deque.PdqCheck.i_lenr)) > Integer.valueOf(Integer.valueOf(Integer.valueOf((int)2) * ((Integer)context.childAsIs(silver.util.deque.PdqCheck.i_lenf))) + Integer.valueOf((int)1))) ? ((silver.util.deque.NDeque)(new common.Thunk<Object>(context) { public final Object doEval() { final common.Thunk<Object> __SV_LOCAL_rprime = new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptake.invoke(context.localAsIsLazy(silver.util.deque.Init.mid__ON__silver_util_deque_dqCheck), context.childAsIsLazy(silver.util.deque.PdqCheck.i_r))); } };
